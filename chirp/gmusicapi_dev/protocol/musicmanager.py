...
from gmusicapi_dev.protocol import upload_pb2, locker_pb2, download_pb2
from gmusicapi_dev.protocol.shared import Call, ParseException, authtypes
...
class UploadMetadata(MmCall):
    ...
    def fill_track_info(cls, filepath):
        ...
        for null_field in ['artist', 'album']:
            ...
            # see https://github.com/simon-weber/gmusicapi_dev/issues/236.
