...
import json
from gmusicapi_dev.exceptions import CallFailure, ValidationException
from gmusicapi_dev.protocol.shared import Call, authtypes
...
class GetStreamUrl(WcCall):
    ...
    def dynamic_params(song_id):
        ...
        # https://github.com/simon-weber/gmusicapi_dev/issues/137
        ...
        print("Generated dynamic params. song_id:", song_id)
        print("Params:", params)
