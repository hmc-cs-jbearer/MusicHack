...
from gmusicapi_dev.exceptions import (
...
class _Base(object):
    ...
    def _send_without_auth(self, req_kwargs, rsession):
        ...
        print("Sending request. kwargs:", req_kwargs)
...
class Webclient(_Base):
    def login(self, email, password, *args, **kwargs):
        ...
        print("Cookies:", browser.session.cookies)
    ...
    def _send_with_auth(self, req_kwargs, desired_auth, rsession):
        if desired_auth.xt:
            ...
            print("sending with auth. kwargs:", req_kwargs)
