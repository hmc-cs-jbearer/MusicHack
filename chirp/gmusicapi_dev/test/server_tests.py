...
from gmusicapi_dev import Webclient, Musicmanager, Mobileclient
# from gmusicapi_dev.protocol import mobileclient
from gmusicapi_dev.protocol.shared import authtypes
from gmusicapi_dev.utils.utils import retry, id_or_nid
import gmusicapi_dev.test.utils as test_utils

TEST_PLAYLIST_NAME = 'gmusicapi_dev_test_playlist'
TEST_PLAYLIST_DESCRIPTION = 'gmusicapi_dev test playlist'
TEST_STATION_NAME = 'gmusicapi_dev_test_station'
...
class ClientTests(object):
    ...
    # Fails silently. See https://github.com/simon-weber/gmusicapi_dev/issues/349.
    # @song_test
    # @all_access
