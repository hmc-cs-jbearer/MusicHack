...
from gmusicapi_dev.clients import Webclient, Musicmanager, Mobileclient, OAUTH_FILEPATH
from gmusicapi_dev.protocol.musicmanager import credentials_from_refresh_token
from gmusicapi_dev.test import local_tests, server_tests  # noqa
from gmusicapi_dev.test.utils import NoticeLogging
...
def main():
    ...
    root_logger = logging.getLogger('gmusicapi_dev')
