...
from gmusicapi_dev.exceptions import CallFailure, NotSubscribed
...
class Mobileclient(_Base):
    ...
    def get_stream_url(self, song_id, device_id=None, quality='hi'):
        ...
        :param device_id: (optional) defaults to ``android_id`` from login.
          ...
          <gmusicapi_dev.clients.Mobileclient.get_registered_devices>` will provide
    ...
    def add_songs_to_playlist(self, playlist_id, song_ids):
        ...
        <https://github.com/simon-weber/gmusicapi_dev/issues/239>`__).
        """
