...
from gmusicapi_dev.protocol import webclient
from gmusicapi_dev.utils import utils
import gmusicapi_dev.session
...
class Webclient(_Base):
    ...
    _session_class = gmusicapi_dev.session.Webclient
    ...
    def get_stream_urls(self, song_id):
        ...
        If you just need the audio and are ok with gmusicapi_dev doing the download,
        ...
        *This is only intended for streaming*. The streamed audio does not contain metadata.
        ...
        <gmusicapi_dev.clients.Musicmanager.download_song>`
    ...
    def report_incorrect_match(self, song_ids):
        ...
        Note that if you uploaded a song through gmusicapi_dev, it won't be reuploaded
        automatically - this currently only works for songs uploaded with the Music Manager.
        See issue `#89 <https://github.com/simon-weber/gmusicapi_dev/issues/89>`__.
